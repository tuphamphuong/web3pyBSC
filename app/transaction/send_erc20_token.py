...
print("w3.eth.get_balance(my_metamask_account) ", account_from_account_balance)
...
print("w3.eth.get_transaction_receipt ", web3.eth.get_transaction_receipt(send_raw_txn_result))