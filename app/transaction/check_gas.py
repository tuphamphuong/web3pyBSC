...
#TODO: Still return none whatever change from testnet to mainnet
print("web3.eth.generate_gas_price() ", web3.eth.generate_gas_price())

print("web3.eth.gasPrice() ", web3.eth.gasPrice)